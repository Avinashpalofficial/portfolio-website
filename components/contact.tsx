            ...
            <CardContent className="p-8">
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground group-hover:text-primary transition-colors">avinash@example.com</p>
                  </div>
                </Link>
              ...
              <div className="mt-8 pt-8 border-t border-border">
                ...
                <div className="flex gap-3">
                  <Button variant="outline" size="icon" asChild className="hover:bg-primary/10 hover:text-primary hover:border-primary transition-colors">
            ...
            <CardContent className="p-8 flex flex-col justify-center h-full">
              <div className="mb-6">
                ...
                <p className="opacity-90 leading-relaxed">
                  Let&apos;s collaborate to bring your ideas to life. Whether you need a new website, web application, or want to improve an existing project, I&apos;m here to help.
                </p>
              </div>
              ...
              >
                <Link href="mailto:avinash@example.com" className="gap-2">
